...
struct ActivityLogView: View {
    ...
    private func entryCard(_ entry: AuditLogEntry) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                infoBlock(
                    title: settings.language == .spanish ? "Detalle" : "Detail",
                    value: entry.detail,
    ...
    private func infoBlock(title: String, value: String, tint: Color) -> some View {
        ...
        .padding(14)
        .background(BrandPalette.surface.opacity(0.9))
        .overlay(
            RoundedRectangle(cornerRadius: 18, style: .continuous)
