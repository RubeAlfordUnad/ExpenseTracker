...
struct TermsView: View {
    ...
    private var termsText: String {
        ...
        case .spanish:
            ...
            1. Uso de la app
            \(AppMetadata.displayName) es una herramienta de organización financiera personal. Su objetivo es ayudarte a registrar y visualizar gastos, ingresos, deudas, pagos fijos y presupuestos.

            2. No es asesoría financiera
            \(AppMetadata.displayName) no ofrece asesoría financiera, contable, tributaria, legal ni bancaria. La información mostrada por la app es únicamente de apoyo y organización personal.
            ...
            4. Cuenta local
            Si creas una cuenta local dentro de la app, eres responsable de conservar tus credenciales y del acceso al dispositivo donde usas \(AppMetadata.displayName).
        ...
        case .english:
            ...
            1. App usage
            \(AppMetadata.displayName) is a personal finance organization tool. Its purpose is to help you record and view expenses, income, debts, recurring payments, and budgets.

            2. Not financial advice
            \(AppMetadata.displayName) does not provide financial, accounting, tax, legal, or banking advice. Information shown by the app is intended only for personal organization and support.
            ...
            4. Local account
            If you create a local account inside the app, you are responsible for keeping your credentials safe and for access to the device where \(AppMetadata.displayName) is used.
